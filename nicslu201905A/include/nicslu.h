...
cfg[3]: ordering method. 0: no ordering; 1: user-provided ordering; 2: the best one among built-in methods;
        3 or -3: AMD; 4 or -4: modified AMD; 5 or -5: AMF; 6 or -6: modified AMF 1. 7 or -7: modified AMF 2.
        8 or -8: modified AMF 3. Negative: the order will be outputed. [default] 2
