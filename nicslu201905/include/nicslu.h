...
cfg[3]: ordering method. 0: no ordering; 1: user-provided ordering; 2 or -2: AMD; 3 or -3: modified AMD;
        4 or -4: COLAMD; 5 or -5: METIS; 6 or -6: AMF; 7 or -7: modified AMF 1. 8 or -8: modified AMF 2.
        9 or -9: modified AMF 3. 10 or -10: best one in AMD, mAMD, AMF, mAMF1, mAMF2 and mAMF3. Negative: 
        the order will be outputed. [default] 10
cfg[4]: threshold for dense rows for AMD, COLAMD and AMF. [default] 10.0
