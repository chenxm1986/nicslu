...
stat[16]: selected opdering method
...
cfg[3]: ordering method. 0: no ordering; 1: user-provided ordering; 2 or -2: selects the best one among 
        built-in methods in parallel; 3 or -3: selects the best one among built-in methods in sequential.
        4 or -4: AMD; 5 or -5: modified AMD; 6 or -6: AMF; 7 or -7: modified AMF 1. 8 or -8: modified AMF 2.
        9 or -9: modified AMF 3. Negative: the order will be outputed. [default] 2
...
typedef enum
{
	ORDERING_NATURAL = 0,
	ORDERING_USER,
	ORDERING_BEST_PARALLEL,/*default*/
	ORDERING_BEST_SEQUENTIAL,
	ORDERING_AMD,
	ORDERING_mAMD,
	ORDERING_AMF,
	ORDERING_mAMF1,
